...
public class LoadTestingAuthenticationService implements AuthenticationService {
   ...
   public void logIn() throws AuthenticationException {
      ...
      try {
         ...
         Launcher.getInstance().println("Couldn\'t load-test new authentication service (method: logIn)", var2);
      }
   ...
   public void selectGameProfile(GameProfile profile) throws AuthenticationException {
      ...
      try {
         ...
         Launcher.getInstance().println("Couldn\'t load-test new authentication service (method: selectGameProfile)", var3);
      }
